class livro
{
    ...
    public string Titulo
    {
        ...
        set
        {
            titulo = string.IsNullorWhiteSpace(value) ? "Titulo não encontrado" : value;
        }
    }
...
class Filme 
{
    ...
    public string Nome 
    {
        ...
        set
        {
            nome = string.IsNullorWhiteSpace(value) ? "Filme sem titulo" : value;
        }
    }
    ...
    public string tituloObra
    {
        ...
        set
        {
            tituloObra = string.IsNullorWhiteSpace(value) ? "Obra sem títul" : value;
        }
    }
